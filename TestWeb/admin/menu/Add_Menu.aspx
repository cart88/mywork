<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Add_Menu.aspx.cs" Inherits="admin_menu_Add_Menu" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>系统文件菜单添加</title>
...
<body>
    <form id="form1" runat="server">
        <div id="main">
        <div id="nav">
            <a href="#">无聊管理系统</a> > <a href="#">菜单管理</a> > 文件菜单添加
        </div>
        <div id="content">
            <table border="0" cellspacing="1" cellpadding="3" class="table">
                ...
                <tr>
                    ...
                    <td>
                        <input runat="server" type="text" class="input" id="txtMenuImg" onfocus="javascript:this.select();" value="../Images/Ico/null.gif" /><img alt="默认图标" src="../../Images/Ico/null.gif" class="MenuImgStle" />
                    </td>
                </tr>
                <tr>
